...
public class GuessTheNumber {
    public static void main(String[] args) {
        ...
        for (int round = 1; round <= MAX_ROUNDS; round++) {
            ...
            System.out.println("The secret number is"+secretNumber);//as it is generated by system.we cant determine what it is so ,to know what is the number,we are printing it in console.
            int attempts = 0;
            int roundScore = 0;
